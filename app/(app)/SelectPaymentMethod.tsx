    ...
    <SafeAreaView className="flex-1 bg-black">
      <View className="flex-1 flex-col gap-5">
        ...
        <View className="p-5 flex-1 flex-col gap-5">
          ...
          <TouchableOpacity onPress={() => router.push("/CardDetails")} className="bg-[#1A1A1A] items-center justify-between flex flex-row p-5">
            <View className="flex items-center flex-row gap-3">
              <View className="bg-[#0e0d0d] h-20 flex justify-center items-center w-20 rounded-full">
                <FontAwesome name="credit-card-alt" size={24} color="#2DC85B" />
              </View>
          ...
          <TouchableOpacity onPress={() => router.push("/CardDetails")} className="bg-primary/50 mt-16 p-4 rounded-full">
